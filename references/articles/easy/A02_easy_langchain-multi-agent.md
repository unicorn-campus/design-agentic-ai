...
- `Subagents` — 대표 한 명이 부하 담당자들을 도구처럼 부릅니다.  
  모든 연락은 대표를 거칩니다. 팀장이 실무자에게 시키고 보고받는 모습입니다.
  ![Subagents 패턴 — 대표가 부하 담당자들을 도구처럼 부르는 구조](images/2026-08-05-21-26-35.png)  
  *원문 「Patterns」 그림 캡처 (2026-08-05 조회)*  
    
- `Handoffs` — 담당자끼리 일을 직접 넘깁니다.  
  콜센터에서 "제가 도와드릴 수 없어 다른 부서로 돌려드리겠습니다"와 같습니다.
  ![Handoffs 패턴 — 담당자끼리 일을 직접 넘기는 구조](images/2026-08-05-21-26-53.png)  
  *원문 「Patterns」 그림 캡처 (2026-08-05 조회)*  
    
- `Skills` — 담당자는 한 명 그대로 두고, 필요한 지식만 그때그때 꺼내 옵니다.  
  직원 한 명이 필요할 때만 매뉴얼을 펼쳐 보는 방식입니다.
  ![Skills 패턴 — 담당자는 하나, 지식만 꺼내 쓰는 구조](images/2026-08-05-21-27-13.png)  
  *원문 「Patterns」 그림 캡처 (2026-08-05 조회)*  

- `Router` — 앞에 분류 담당을 하나 두고, 질문을 알맞은 곳으로 보냅니다.  
  받은 답들을 합쳐 하나로 만들어 줍니다. Subagents와 다른 점은 반복이 없다는 것임.  
  ![Router 패턴 — 앞에서 분류해 알맞은 곳으로 보내는 구조](images/2026-08-05-21-27-33.png)  
  *원문 「Patterns」 그림 캡처 (2026-08-05 조회)*  
